<?php
/**
 * panel.php — Dashboard (TAZE kopya).
 *
 * index.php, sunucudaki PHP OPcache'e takıldığı için (validate_timestamps kapalı +
 * opcache_reset kısıtlı) diskteki güncel kod yerine ESKİ derlenmiş sürümü çalıştırıyor
 * ve yanlış rakam (5.247,9/589) gösteriyordu. Bu dosya YENİ olduğundan OPcache onu
 * sıfırdan derler → güncel kod, doğru rakam (5.253,0/590). İçerik index.php ile
 * birebir aynıdır. Kalıcı çözüm: cPanel MultiPHP INI Editor'den
 * opcache.validate_timestamps=1 yapmak ya da PHP'yi yeniden başlatmak.
 */
...
<div class="d-flex flex-wrap justify-content-between align-items-start mb-3 gap-2">
    <div>
        ...
        <div class="text-muted small mt-1">
            ...
            <span class="badge bg-success ms-2" title="panel.php CANLI — sunucu saati ve o an hesaplanan toplam. Bu rozet görünüyorsa yeni taze dashboard çalışıyor demektir">CANLI panel · <?= date('H:i:s') ?> · <?= number_format((float)$toplamM3,1,',','.') ?> m³</span>
        </div>
        <?php endif; ?>
    </div>
