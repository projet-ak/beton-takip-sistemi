...
function mesaj_ai_ayikla(PDO $pdo, string $metin, array $gorseller = []): array
{
    ...
    $system = "Sen bir şantiye giriş-kontrol asistanısın. WhatsApp saha grubundan gelen mesajı okur, "
        ...
        . "- MÜKERRER ÜRETME: mesaj metni ile fiş AYNI aracın AYNI hareketini anlatıyorsa yalnız\n"
        . "  FİŞTEN tek olay üret (fiş esas). Metinden aynı plaka için ikinci bir giriş/çıkış olayı ÇIKARMA.\n"
        . "- Fişteki tarih ile mesajın gönderildiği gün çelişirse FİŞTEKİ tarihi kullan.\n"
        . "- onaylayan alanına fişteki OPERATÖR/KANTAR gibi alan etiketlerini YAZMA; onaylayan yalnız\n"
        . "  mesaj metninde bir KİŞİNİN onay verdiği açıkça yazıyorsa doldurulur, yoksa boş kalır.\n"
