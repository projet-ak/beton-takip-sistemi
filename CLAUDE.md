...
- **`kotlar.php`** — kot **detay/kat etiketi** (`kotlar.aciklama`, runtime ALTER + kurulum) + **VERİ sekmesinden kat etiketi doldurma** (kot→KAT haritası; yalnız boş detaylar doldurulur) + kot başına **döküm özeti** (m³/irsaliye adedi/imalat kalemleri) ve m³'e tıklayınca o kottaki irsaliyeler popup — "hangi blok hangi kot ne yapılmış".
