...
function sayfa_islemi(): string
{
    ...
    $girisSayfa = preg_match('/^(import\d*|cihaz_import|form_import|toplu_cihaz|snipe_cek|toplu_irsaliye|hizli_tarama|belge_dagit|fatura_eslestir|faturalar|hizli_kaydet|hizli_guncelle|ai_okut|demir_okut|demir_scan_kaydet|demir_pdf_kaydet|pdf_kaydet|foto_yukle)\.php$/', $s)
